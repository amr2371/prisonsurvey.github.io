...
Fitting a full model, we can see that ALL of these variables are significant at the 0.05 level, but our AIC is quite high. Let's try finding a sub-model using backwards selection:  
